...
> Este documento marca la pauta de *por qué* existe este sistema. Cuando el código se vuelva complejo, vuelve aquí para recordar que el valor real de "Gestion de Activos de PIHCSA" no es solo guardar datos, sino eliminar el caos de los archivos Excel y convertirlos en **integridad operativa**.
