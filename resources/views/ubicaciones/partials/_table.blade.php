                    ...
                    <tr id="ubicacion-{{ $ubicacion->id }}">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="secondary-data">
                                        <i class="fas fa-door-open mr-1 text-red-pure"></i>Ubicación física
                                    </span>
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="badge badge-light border px-2 py-1" style="font-size: 0.9rem;">
                                <i class="fas fa-hashtag text-red-pure mr-1 small"></i> {{ $ubicacion->codigo }}
                            </span>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center py-5 text-muted">
                            <i class="fas fa-map-marked-alt fa-3x mb-3 d-block text-red-pure" style="opacity: 0.3;"></i>
