<!-- Flash Data -->
    ...
    @if(session('warning') && session('actualizado_id'))
        @php $equipoActualizado = \App\Models\Equipo::find(session('actualizado_id')); @endphp
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="ml-3">
                    ...
                    style="transition: all 0.3s ease; text-decoration: none; color: #333;">
                        <i class="fas fa-history mr-2"></i> Ver Cambios
                        @if($equipoActualizado)
                            ACT-{{ str_pad($equipoActualizado->ID, 3, '0', STR_PAD_LEFT) }}
                        @endif
                    </a>
                </div>
            </div>
    ...
    @if(session('success') && session('new_id'))
        @php $equipoNuevo = \App\Models\Equipo::find(session('new_id')); @endphp
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="ml-3">
                    ...
                    style="transition: all 0.3s ease; text-decoration: none;">
                        ...
                        @if($equipoNuevo)
                            ACT-{{ str_pad($equipoNuevo->folio, 3, '0', STR_PAD_LEFT) }}
                        @endif
                    </a>
                </div>
            </div>
    ...
    @if(session('secondary') && session('new_mantenimiento'))
        @php $equipoMant = \App\Models\Equipo::find(session('new_mantenimiento')); @endphp
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="ml-3">
                    ...
                    style="transition: all 0.3s ease; text-decoration: none;">
                        ...
                        @if($equipoMant)
                            ACT-{{ str_pad($equipoMant->folio, 3, '0', STR_PAD_LEFT) }}
                        @endif
                    </a>
                </div>
            </div>
    ...
    @if(session('actualizado_factura'))
        @php $equipoFactura = \App\Models\Equipo::find(session('actualizado_factura')); @endphp
        <div class="callout callout-warning alert alert-dismissible shadow-sm mb-4" 
            role="alert" 
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="ml-3">
                    ...
                    style="transition: all 0.3s ease; text-decoration: none; color: #333; background-color: #ffc107; border-color: #ffc107;">
                        <i class="fas fa-search-dollar mr-2"></i> Ver Historial
                        @if($equipoFactura)
                            ACT-{{ str_pad($equipoFactura->folio, 3, '0', STR_PAD_LEFT) }}
                        @endif
                    </a>
                </div>
            </div>
