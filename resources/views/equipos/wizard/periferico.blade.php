    ...
    <div class="card-body p-3 d-flex align-items-center">
        <div class="flex-grow-1">
            <div class="d-flex justify-content-around text-center wizard-steps">
                ...
                <div class="wizard-step completed">
                    <a href="{{ route('equipos.wizard.procesador', $uuid) }}" class="text-success" style="text-decoration: none;">
                        <i class="fas fa-check-circle"></i>
                ...
                <div class="wizard-step active">
                    <a href="{{ route('equipos.wizard.periferico', $uuid) }}" class="text-primary font-weight-bold" style="text-decoration: none;">
                        <i class="fas fa-mouse"></i>
                        <div class="small">Periferico</div>
                    </a>
                </div>
